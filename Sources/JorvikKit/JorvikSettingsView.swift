    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            Form {
                ...
                // Updates…" entry. Interval and auto-install preferences
                // are configured via Info.plist (SUScheduledCheckInterval)
                // and Sparkle's own update prompt (the "Automatically
                // download and install updates in the future" checkbox).
            }
            .formStyle(.grouped)
